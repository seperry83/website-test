...
PhytoStringClass <- R6Class(
  ...
  public = list(
    ...
    alg_list_txt = function() {
      alg_cat <- private$def_alg_cat(self$df_raw, 5)  # Call the private method from the parent class
