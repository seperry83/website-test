...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_station_map.jpg')))
```
...
`r stats_pwq_cur$calc_chla_above()`% of samples had chlorophyll *a* levels below 10 μg/L, which is considered limiting for zooplankton growth (Müller-Solger et al., 2002). `r strings_pwq_cur$disp_phyto_paragraph('Chla','median')` `r strings_pwq_cur$disp_phyto_paragraph('Pheoa','median')`
