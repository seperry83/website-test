...
knitr::include_graphics(here::here(file.path('admin/figures-tables/cwq/fig_watertemperature.jpg')))
```
...
knitr::include_graphics(here::here(file.path('admin/figures-tables/cwq/fig_spc.jpg')))
```
...
knitr::include_graphics(here::here(file.path('admin/figures-tables/cwq/fig_dissolvedoxygen.jpg')))
```
...
knitr::include_graphics(here::here(file.path('admin/figures-tables/cwq/fig_ph.jpg')))
```
...
knitr::include_graphics(here::here(file.path('admin/figures-tables/cwq/fig_turbidity.jpg')))
```
...
knitr::include_graphics(here::here(file.path('admin/figures-tables/cwq/fig_fluorescence.jpg')))
```
