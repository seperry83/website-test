...
knitr::include_graphics(here::here(file.path('admin/figures-tables/dwq/fig_spcndsurface.jpg')))
```
...
include_graphics(here::here(file.path('admin/figures-tables/dwq/fig_turbiditysurface.jpg')))
```
...
knitr::include_graphics(here::here(file.path('admin/figures-tables/dwq/fig_dissammonia.jpg')))
```
...
knitr::include_graphics(here::here(file.path('admin/figures-tables/dwq/fig_chla.jpg')))
```
...
knitr::include_graphics(here::here(file.path('admin/figures-tables/dwq/fig_dissnitratenitrite.jpg')))
```
...
knitr::include_graphics(here::here(file.path('admin/figures-tables/dwq/fig_totphos.jpg')))
```
